...
const MANUAL_OVERRIDES = [
  ...
  ["wiz.io/careers/job/4688850006", "live"], // Greenhouse API + WebFetch of rendered page both confirm live (deadline 08/03/2026) Jul 23 2026 — curl's body match hits "Page not found" inside Wiz's JS i18n bundle, not real page content
];
